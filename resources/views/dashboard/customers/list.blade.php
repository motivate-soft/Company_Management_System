...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ url('add-customer') }}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __('customers/customers.customerAdd') }}</a>
            </div>                        
        </div>
    </div>          
</div>
                        ...
                        <table class="table table-borderless" id="default-datatable">  
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('customers/customers.customerPhone') }}</th>
                                    <th>{{ __('customers/customers.customerStatus') }}</th>
                                    <th>Actions</th>  
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <label class="custom-control-label" for="customSwitch{{$key}}"></label>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a class="btn btn-success-rgba" href="{{ url('/edit-customer').'/'.$customer->id }}" ><i class="feather icon-edit-2"></i></a> 

                                            <a href="{{ url('/del-customer/'.$customer->id) }}" class="btn btn-danger-rgba" onclick="return confirm('Are you sure？')"><i class="feather icon-trash"></i></a>  
                                        </div>  
                                    </td>
                                </tr>
                                @endforeach
