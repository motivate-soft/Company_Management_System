        ...
        <div class="modal-content">
                    ...
                    <tbody class="states_model">
                        <form id="products_form">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <input type="number" class="form-control product-qty" value="{{$itm['quantity']}}" name="product_quantity[]" data-id="{{$itm['product']['id']}}" data-price="{{ $itm['product']['price'] }}" placeholder="type number">
                                </td>
                                <td style="text-align: center;">
                                    ${{ $itm['product']['price'] }}
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    @if($product->image != '')
                                        <img style="border-radius: 50%;" src="{{ url('uploads/product_images') }}/{{ $product->image }}" class="img-fluid" width="35">
                                    @else
                                        <img style="border-radius: 50%;" src="{{ url('assets/dashboard/images/no-image.jpg') }}" class="img-fluid" width="35">
                                    @endif
                                </td> 
                                ...
                                <td>
                                    <input style="text-align: center;" type="number" class="form-control product-qty" name="product_quantity[]" data-id="{{$product->id}}" data-price="{{$product->price}}" placeholder="type number">
                                </td>
                                <td style="text-align: center;">
                                    {{ $product->price }}
                                </td>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateProduct()">
                    <i class="bx bx-x d-block d-sm-none"></i>
                    <span class="d-none d-sm-block">{{ __('general.update') }}</span>
                </button>
