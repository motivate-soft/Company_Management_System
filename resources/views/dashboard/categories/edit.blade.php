                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" @if(isset($data->name)) value="{{ $data->name }}"@endif name="categoryName" class="form-control" placeholder="{{__('category.AddnewName')}}" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" @if(isset($data->code)) value="{{ $data->code }}"@endif name="categoryCode" class="form-control" placeholder="{{__('category.AddnewCode')}}" required="">
                            </div>
                        </div>
