                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" @if(isset($data->code)) value="{{ $data->code }}"@endif name="brandCode" class="form-control" placeholder="{{__('brand.AddnewCode')}}" required="" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" @if(isset($data->created_by)) value="{{ $data->created_by }}"@endif name="nameOfAdd" class="form-control" placeholder="{{__('brand.AddnewNameof')}}" required="" disabled>
                            </div>
                        </div>
