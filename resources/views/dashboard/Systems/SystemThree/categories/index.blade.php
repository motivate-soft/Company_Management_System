...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">{{__('products\category.title')}}</h4>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('categories.create') }}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{__('products\category.categoryAdd')}}</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless" id="default-datatable">
                            <thead>
                                <tr>
                                    <th>{{ __('products\category.id') }}</th>
                                    <th>{{ __('products\category.categoryName') }}</th>
                                    <th>{{ __('products\category.categoryNameAr') }}</th>
                                    <th>{{ __('products\category.categoryCode') }}</th>
                                    <th>{{ __('products\category.nameOfAdd') }}</th>
                                    <th>{{ __('products\category.dateOfAdd') }}</th>
                                    <th>{{ __('products\category.categoryDetail') }}</th>
                                    <th>{{ __('products\category.categoryEdit') }}</th>
                                    <th>{{ __('products\category.categoryDelete') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(count($cuttings) > 0)
