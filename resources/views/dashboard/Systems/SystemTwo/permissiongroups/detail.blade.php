@section('title')
    {{__('Systems/SystemTwo/permissiongroups.permissiongroup_add')}}
@endsection
...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">{{__('Systems/SystemTwo/permissiongroups.detail')}}</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Systems/SystemTwo/permissiongroups.detail')}}</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" placeholder="name" class="form-control" @if(isset($permissiongroup->name)) value="{{ $permissiongroup->name }}" @endif name="name" required="" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" placeholder="ar_name" class="form-control" @if(isset($permissiongroup->ar_name)) value="{{ $permissiongroup->ar_name }}" @endif name="ar_name" required="" disabled>
                            </div>
                        </div>
