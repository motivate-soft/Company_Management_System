        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Plugin</li>
                </ol>
            </div>
        </div>
...
<div class="contentbar">                
    ...
    <div class="row">
        <!-- Start col -->
        <div class="col-lg-12">
            <form method="post" action="{{ url('add_plugin') }}" enctype="multipart/form-data">
            @csrf
        ...
        <div class="card-body tab-content" style="text-align: left;">
            <div class="form-group row tab-pane fade show" id="pills-english-product-information-justified" role="tabpanel" aria-labelledby="pills-english-product-information-tab-justified">
                ...
                <div class="col-sm-12">
                    <input type="text" name="name_en" class="form-control font-20" id="name" required>
                </div>
                <label class="col-sm-12 col-form-label">Plugin Description</label>
                <div class="col-sm-12">
                    <textarea class="form-control input-block-level" rows="5" name="description_en" ></textarea>
                </div>
            </div>
            ...
            <div class="form-group row tab-pane fade show active" style="text-align: right;" id="pills-arabic-product-information-justified" role="tabpanel" aria-labelledby="pills-arabic-product-information-tab-justified">
                ...
                <div class="col-sm-12">
                    <input style="text-align: right; font-family: 'Tajawal', sans-serif;" type="text" name="name_ar" class="form-control font-20" id="name" required>
                </div>
                ...
                <div style="font-family: 'Tajawal', sans-serif;" class="col-sm-12">
                    <textarea class="form-control input-block-level" name="description_ar" rows="5"></textarea>
                </div>
            </div>
            ...
            <div class="row"> 
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" name="url" placeholder="Plugin Url" required="">
                        </div>
                    </div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="d-inline-block mb-1">
                        <img id="imagePreview" src="assets/dashboard/images/default.png" alt="Rounded Image" class="img-fluid rounded" style="width: 200px;height: 200px;object-fit: cover;"> 
                    </div>
                </div> 
