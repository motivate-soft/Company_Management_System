	...
	<!-- Basic Page Needs
	================================================== -->
	<title>eSports &amp; Gaming HTML Template - Home 1</title>
	<meta charset="utf-8">
	...
	<!-- Google Web Fonts
	================================================== -->
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700|Roboto+Condensed:400,400i,700,700i"
		rel="stylesheet">
	...
	<!-- REVEAL ADD-ON FILES -->
	<link rel="stylesheet" href="{{asset('assets/frontend/desktop_themes/theme_1/vendor/revolution-addons/reveal/css/revolution.addon.revealer.css?ver=1.0.0')}}"
		type="text/css" media="all" />
	<link rel="stylesheet"
		href="{{asset('assets/frontend/desktop_themes/theme_1/vendor/revolution-addons/reveal/css/revolution.addon.revealer.preloaders.css?ver=1.0.0')}}"
		type="text/css" media="all" />

	<!-- TYPEWRITER ADD-ON FILES -->
	<link rel="stylesheet" href="{{asset('assets/frontend/desktop_themes/theme_1/vendor/revolution-addons/typewriter/css/typewriter.css')}}" type="text/css"
		media="all" />

	<!-- Template CSS-->
	<link href="{{asset('assets/frontend/desktop_themes/theme_1/css/style-esports.css')}}" rel="stylesheet">
